...
export const metadata = {
  ...
  description: 'Cadastre-se como estabelecimento ou como freelancer.',
}
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          >
            ...
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
              Restaurantes, bares e hotéis que desejam contratar profissionais para turnos.
            </p>
          ...
          >
            ...
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
              Profissionais que querem atuar em turnos em estabelecimentos parceiros.
            </p>
            <span className="mt-4 inline-flex items-center text-sm font-bold text-primary">
              Criar conta
              <svg className="ml-1 size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
